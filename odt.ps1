...
$product  = $products[$prodChoice].ID
$channel  = $products[$prodChoice].Channel
...
# Invoke-WebRequest -Uri $setupUrl -OutFile $setupPath -Varianta veche de descarcare

# Varianta moderna cu progress bar
